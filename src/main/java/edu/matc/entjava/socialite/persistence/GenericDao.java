...
public class GenericDao<T> {
    ...
    /**
     * Gets a entity by id
     * @param id eneity id to search by
     * @return a entity
     */
     ...
     * @return id of the inserted book
     */
     ...
     * sample usage: getByPropertyValue("lastName", "Curry")
     *
     * @param propertyName entity property to search by
     * @param value value of the property to search for
     * @return list of entity meeting the criteria search
     */
    public List<T> getByPropertyValue(String propertyName, T value) {
        Session session = getSession();

        logger.debug("property" + propertyName + " = " + value);
